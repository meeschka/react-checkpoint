...
const GuidePage = (props) => (
    <div className='d-flex'>
        ...
        <div className='guide-page-content'>
            ...
            <p>
                We all have goals and plans. Some are fuzzy, like the feeling that we really should loose some weight or contact that old school friend. Other goals are
                ...
                entirely forgotten your plans to conquer the world, until the next new year or birthday rolls around. It's time to actually start acheiving your dreams.
            </p>
            <p>
            ...
            <p>
                As a user, you make checkpoints: a collection of goals and observations lumped into easy to manage categories. For example, you might have categories for health, finance,
                ...
                guide you in the setting of goals and challenges: what can you do to fix the aspects you don't like? What can you do to increase the good things in this category? Each checkpoint comes
                with the option of setting up reminder notifications which are texted to you once a week, to help you further focus.
            </p>
            <p>
                Goals are items you will be working towards and items you are trying to incorporate into your routine more regularly. This is a very flexible item, and might include what you'll be doing (practicing piano for at least 30 minutes every day? Contacting old
                friends at least twice a week? Limiting meals out to once a week?). This allows you to really make goals work for you. For each goal, you have the option of entering specific steps and the reasons for making the goal.
            ...
            <p>
                Checkpoint was designed and built by Michelle Pitts Linley in one week for Project 4 of General Assembly's Software Engineering Immersive Bootcamp. It was built using
            ...
            <p>
                ...
                of goals, and, perhaps most importantly, a means of tracking daily progress. This allows users to remain focused on their progress and on the goals themselves. For more technical details about the
